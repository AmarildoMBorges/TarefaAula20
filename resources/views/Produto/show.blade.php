...
<body>
    <div class="container">
        ...
        <div class="form-group">
            <label for="id-updated">{{__('msgLang.cmpDatAtu')}}</label>
            <input type="text" class="form-control" id="id-updated" value={{$produto->updated_at}} disabled>
        </div>
        <div class="form-group">
            <label for="id-created">{{__('msgLang.cmpDatCri')}}</label>
