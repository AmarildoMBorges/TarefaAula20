...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{__('msgLang.titPagPri')}}</title>
    </head>
    <body>
        <div class="container mt-4">
            ...
            <div class="content text-center">
                <div class="title a-b-md">
                <h1>{{__('msgLang.msgBemVin')}}</h1>
                </div>
                <p>{{__('msgLang.msgEscIdi')}}</p> 
                <div class="links">
                    <a href="lang/en">Ingles</a>
                    <a href="lang/es">Espanhol</a>
                        ...
                        <div class="col-lg-4">
                            <div class="card bg-light mb-3 text-center mx-auto">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <a class="btn btn-primary" href="{{ url('/home') }}">{{__('msgLang.titDoUsu')}}</a>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="col-lg-4">
                            <div class="card bg-light mb-3 text-center mx-auto">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <a class="btn btn-primary" href="{{ route('login') }}">{{__('msgLang.lblTitUsu')}}</a>
                                </div>
                            </div>
                        </div>
                        @if (Route::has('register'))
                            <div class="col-lg-4">
                                <div class="card bg-light mb-3 text-center mx-auto">
                                    ...
                                    <div class="card-body align-items-center d-flex justify-content-center">
                                        <a class="btn btn-primary" href="{{ route('register') }}">{{__('msgLang.titRegUsu')}}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    @if(Auth::guard('admin')->check())
                        <div class="col-lg-4">
                            <div class="card bg-light mb-3 text-center mx-auto">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <a class="btn btn-primary" href="{{ url('/admin') }}">{{__('msgLang.titDoAdm')}}</a>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="col-lg-4">
                            <div class="card bg-light mb-3 text-center mx-auto">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <a class="btn btn-primary" href="{{ route('admin.login') }}">{{__('msgLang.lblTitAdm')}}</a>
                                </div>
                            </div>
                        </div>
                    @endif
